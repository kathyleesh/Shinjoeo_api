...
def logoutView(request):
    logout(request)
    url = str('https://accounts.kakao.com/logout?continue=https%3A%2F%2Fkauth.kakao.com%2Foauth%2Flogout%2Fcallback%3Fclient_id%3Dfad3300d7c33374e2bb2bab358bcbec3%26logout_redirect_uri%3Dhttp%3A%2F%2Fshinjoeo.s3-website.ap-northeast-2.amazonaws.com%2Fmain')
    return redirect(url)
'''
